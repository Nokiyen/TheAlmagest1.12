...
//		super(name);
	...
	public GameData getConstellation(String constName) {
		
		return this.gameDataMap.get(DataCategory.CONSTELLATION).get(constName);
	...
	public void setConstellationObtained(String constName) {
		
		this.setObtained(DataCategory.CONSTELLATION, constName);
