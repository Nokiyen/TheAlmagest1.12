...
import noki.almagest.saveddata.gamedata.ERandomTalkMira;
...
//					inventory.setInventorySlotContents(0, this.container.bookStack);
	...
	TALK(100){
		...
		private ERandomTalkMira talk;
		
		@Override
		public MiraState initialize(ContainerMira container) {
			
			this.step = 1;
//			this.talk = ERandomTalkMira.getRandomTalk();
			this.talk = ERandomTalkMira.TALK001;
