...
/*	@SubscribeEvent
	...
	public void onPickupItem(EntityItemPickupEvent event) {
		...
		if(AlmagestCore.savedDataManager.getFlagData().getConstellation(constellation.getName()).isObtained() == false) {
			AlmagestCore.savedDataManager.getFlagData().setConstellationObtained(constellation.getName());
		}
